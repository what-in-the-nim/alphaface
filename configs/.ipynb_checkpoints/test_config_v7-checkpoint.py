...
#Config for saving
config.resume = True
config.model_path = './Save/save4/model_last.pt'
config.output = './Save/save4'
...
config.w_percept = 5.0
config.w_2cycle = 1.0
config.w_mask_rec = 1.0
config.w_t_ssim = 1.0
config.w_t_id = 5.0
config.w_face_masked = 1.0
