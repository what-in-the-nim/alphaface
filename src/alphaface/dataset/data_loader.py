...
class TestFaceDataSet(data.Dataset):
    ...
    def __getitem__(self, item):
        ...
        try:
            ...
            print(f"fail to read {source_image_path}")
        ...
        try:
            ...
            print(f"fail to read {reference_image_path}")
...
def get_test_loader(root, test_img_list, img_size=256, batch_size=8, num_workers=4):
    ...
    test_loader = data.DataLoader(
        dataset=test_dataset, batch_size=batch_size, shuffle=False, num_workers=num_workers, drop_last=True
    )
    return test_loader
